...
* [ENHANCEMENT] Ingester: Display user grace interval in tenant list obtained via `/ingester/tenants` endpoint. #11961
...
* [ENHANCEMENT] Update `MimirIngestedDataTooFarInTheFuture` runbook with a note about false positives and endpoint to flush TSDB blocks by user. #11961
